...
############## Archivos de Salida
 ...
 $salida_db_tar = $bak_dir.'/'.$db_name.'-'.$fecha_hoy.'.rar'; //Datos
 
$salida_db_sqlE = $bak_dir.'/'.$db_name.'E-'.$fecha_hoy.'.sql'; //Estructura
$salida_db_tarE = $bak_dir.'/'.$db_name.'E-'.$fecha_hoy.'.rar'; //Estructura
...
//Estructura
 ...
 $a = system($dump);
 $comprime = "rar -czf $salida_db_tarE $salida_db_sqlE";
 $a = system($comprime);
...
echo '			<td width="50%" align="right" valign="middle"><small><img src="img/vfl_ad_bbd.png" alt="" width="325" height="77" /></small></td>';
echo '         </tr>';
echo '       </table>';
...
echo '			<tr>';
echo '			  <td width="100%" colspan="2" align="center"><font face="Comic Sans MS,arial,verdana", size="+2", color="#5B0000">La Copia se ejecuto Exitosamente....!</font></td>';
echo '			</tr>';
echo '		</table>';
echo '		<p>&nbsp;</p>';
echo '		<p>&nbsp;</p>';
