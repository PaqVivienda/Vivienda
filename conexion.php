...
$con = mysqli_connect(SERVERNAME, USERNAME, PASSWORD) or die ('Ha fallado la conexión: '.mysqli_error($con));
mysqli_select_db($con, DB_NAME) or die ('Error al seleccionar la base de datos: '. mysqli_error($con));
