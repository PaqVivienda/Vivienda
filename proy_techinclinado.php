...
// Proyecto (Datos) ***
		$_SESSION['proy_cod'] = $_POST['xproy_cod_incl'];
		$cod_incl = $_SESSION['proy_cod'];
		echo $cod_incl;
	...
	// Construcción Pared Interna
		$_SESSION['piy'] = $_POST['xpiy']; // Longitud Pared Norte - Sur
		$_SESSION['pix'] = $_POST['xpix']; // Longitud Pared Este - Oeste
		// Componentes de Construcción
	// Fin de Paredes
	// Construcción Techo
		$_SESSION['ti_modelo'] = $_POST['xtech_incl_cod']; //
		...
		$_SESSION['ti_desc'] = $row_ti_modelo['proy_descripcion'];
		$_SESSION['ti_esp'] =  $row_ti_modelo['proy_espesor'];
		$_SESSION['ti_dens'] =  $row_ti_modelo['proy_densidad'];
		$_SESSION['ti_cond'] =  $row_ti_modelo['proy_conductividad'];
		$_SESSION['ti_calor'] =  $row_ti_modelo['proy_calorespecifico'];
	...
	// Construcción Pared Interna
		$long_piy = $_SESSION['piy']; // Longitud Pared Norte - Sur
		$long_pix = $_SESSION['pix']; // Longitud Pared Este - Oeste
...
// Fin de la toma de Datos **************************************************************
		...
		print_r(get_table_fields("proy_tech_incl", $con));
