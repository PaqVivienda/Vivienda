...
// Norte
if ( $dens_pta_n < 1 ) {
	$xdens_pta_n = number_format($dens_pta_n*10, 5, ".", "");
} else {
	$xdens_pta_n = number_format($dens_pta_n/1000, 5, ".", "");
}
if ($cond_pta_n < 1) {
	$xcond_pta_n = number_format($cond_pta_n*10, 5, ".", "");
} else {
	$xcond_pta_n = number_format($cond_pta_n/1000, 5, ".", "");
}
if ($cp_pta_n < 1) {
	$xcp_pta_n = number_format($cp_pta_n*10, 5, ".", "");
} else {
	$xcp_pta_n = number_format($cp_pta_n/1000, 5, ".", "");
}
// Sur
if ($dens_pta_s < 1) {
	$xdens_pta_s = number_format($dens_pta_s*10, 5, ".", "");
} else {
	$xdens_pta_s = number_format($dens_pta_s/1000, 5, ".", "");
}
if ($cond_pta_s < 1) {
	$xcond_pta_s = number_format($cond_pta_s*10, 5, ".", "");
} else {
	$xcond_pta_s = number_format($cond_pta_s/1000, 5, ".", "");
}
if ($cp_pta_s < 1) {
	$xcp_pta_s = number_format($cp_pta_s*10, 5, ".", "");
} else {
	$xcp_pta_s = number_format($cp_pta_s/1000, 5, ".", "");
}
// Este
if ($dens_pta_e < 1) {
	$xdens_pta_e = number_format($dens_pta_e*10, 5, ".", "");
} else {
	$xdens_pta_e = number_format($dens_pta_e/1000, 5, ".", "");
}
if ($cond_pta_e < 1) {
	$xcond_pta_e = number_format($cond_pta_e*10, 5, ".", "");
} else {
	$xcond_pta_e = number_format($cond_pta_e/1000, 5, ".", "");
}
if ($cp_pta_e < 1) {
	$xcp_pta_e = number_format($cp_pta_e*10, 5, ".", "");
} else {
	$xcp_pta_e = number_format($cp_pta_e/1000, 5, ".", "");
}
// Oeste
if ($dens_pta_o < 1) {
	$xdens_pta_o = number_format($dens_pta_o*10, 5, ".", "");
} else {
	$xdens_pta_o = number_format($dens_pta_o/1000, 5, ".", "");
}
if ($cond_pta_o < 1) {
	$xcond_pta_o = number_format($cond_pta_o*10, 5, ".", "");
} else {
	$xcond_pta_o = number_format($cond_pta_o/1000, 5, ".", "");
}
if ($cp_pta_o < 1) {
	$xcp_pta_o = number_format($cp_pta_o*10, 5, ".", "");
} else {
	$xcp_pta_o = number_format($cp_pta_o/1000, 5, ".", "");
}
//********************************************************
// Ventana 
// Norte
if ($dens_vna_n < 1) {
	$xdens_vna_n = number_format($dens_vna_n*10, 5, ".", "");
} else {
	$xdens_vna_n = number_format($dens_vna_n/1000, 5, ".", "");
}
if ($cond_vna_n < 1) {
	$xcond_vna_n = number_format($cond_vna_n*10, 5, ".", "");
} else {
	$xcond_vna_n = number_format($cond_vna_n/1000, 5, ".", "");
}
if ($cp_vna_n < 1) {
	$xcp_vna_n = number_format($cp_vna_n*10, 5, ".", "");
} else {
	$xcp_vna_n = number_format($cp_vna_n/1000, 5, ".", "");
}
// Sur
if ($dens_vna_s < 1) {
	$xdens_vna_s = number_format($dens_vna_s*10, 5, ".", "");
} else {
	$xdens_vna_s = number_format($dens_vna_s/1000, 5, ".", "");
}
if ($cond_vna_s < 1) {
	$xcond_vna_s = number_format($cond_vna_s*10, 5, ".", "");
} else {
	$xcond_vna_s = number_format($cond_vna_s/1000, 5, ".", "");
}
if ($cp_vna_s < 1) {
	$xcp_vna_s = number_format($cp_vna_s*10, 5, ".", "");
} else {
	$xcp_vna_s = number_format($cp_vna_s/1000, 5, ".", "");
}
// Este
if ($dens_vna_e < 1) {
	$xdens_vna_e = number_format($dens_vna_e*10, 5, ".", "");
} else {
	$xdens_vna_e = number_format($dens_vna_e/1000, 5, ".", "");
}
if ($cond_vna_e < 1) {
	$xcond_vna_e = number_format($cond_vna_e*10, 5, ".", "");
} else {
	$xcond_vna_e = number_format($cond_vna_e/1000, 5, ".", "");
}
if ($cp_vna_e < 1) {
	$xcp_vna_e = number_format($cp_vna_e*10, 5, ".", "");
} else {
	$xcp_vna_e = number_format($cp_vna_e/1000, 5, ".", "");
}
// Oeste
if ($dens_vna_o < 1) {
	$xdens_vna_o = number_format($dens_vna_o*10, 5, ".", "");
} else {
	$xdens_vna_o = number_format($dens_vna_o/1000, 5, ".", "");
}
if ($cond_vna_o < 1) {
	$xcond_vna_o = number_format($cond_vna_o*10, 5, ".", "");
} else {
	$xcond_vna_o = number_format($cond_vna_o/1000, 5, ".", "");
}
if ($cp_vna_o < 1) {
	$xcp_vna_o = number_format($cp_vna_o*10, 5, ".", "");
} else {
	$xcp_vna_o = number_format($cp_vna_o/1000, 5, ".", "");
}
//********************************************************
// Pared Intern
if ($pi_dens < 1) {
  ...
  for ($Sj = 1; $Sj <= $j; $Sj = $Sj + 1) { // Ciclo de las Paredes Este - Oeste
	...
	// Construccion de Nodos Pared I Pared J Altura K
		...
		if ( $Si == 1 and $Sj == 1 and $Sk > 1 and $Sk < $IJK ) {
			fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_n."E-01". "     ". $xcp_pared_n."E-01". "   ". $xdens_pared_n."E+03". "\r\n");
			$nod_k_ini = $nod_k_ini + 1;
		} else {
		...
		if ( $Si == 1 and $Sj > 1 and $Sj <= 9 and $Sk < $IJK ) {
			if ($Sj == 2 and  $Sk == 2) {
			  if ($NPTAE == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xpe_puerta_cond."E-01". "     ". $xpe_puerta_calor."E-01". "   ". $xpe_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_e."E-01". "     ". $xcp_pared_e."E-01". "   ". $xdens_pared_e."E+03". "\r\n");
			  }
			} else {
			if ($Sj == 2 and  $Sk == 3) {
			  if ($NPTAE == 1) {
			...
			if ($Sj == 4 and  $Sk == 3) {
			  if ($NVNAE == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $ventana. "            ".$xpe_vent_cond."E-01". "     ".$xpe_vent_calor."E-01". "   ".$xpe_vent_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_e."E-01". "     ". $xcp_pared_e."E-01". "   ". $xdens_pared_e."E+03". "\r\n");
			  }
			} else {
		...
		if ( $Si > 1 and $Si <= 9 and $Sj == 1 and $Sk < $IJK ) {
		  if ($Si == 3 and $Sj == 1 and  $Sk == 2) {
			  if ($NPTAN == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xpn_puerta_cond."E-01". "     ".  $xpn_puerta_calor."E-01". "   ". $xpn_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ".$xcond_pared_e."E-01". "     ". $xcp_pared_e."E-01". "   ". $xdens_pared_e."E+03". "\r\n");
			  }
			} else {
			if ($Si == 3 and $Sj == 1 and  $Sk == 3) {
			  if ($NPTAN == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xpn_puerta_cond."E-01". "     ". $xpn_puerta_calor."E-01". "   ". $xpn_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_e."E-01". "     ". $xcp_pared_e."E-01". "   ". $xdens_pared_e."E+03". "\r\n");
		...
		if ( $Si > 1 and $Si <= 9 and $Sj > 1 and $Sj < $j and $Sk < $IJK ) {
		  if ($Si == 4 and ($Sj > 1 and $Sj < $j) and $Sk < $IJK) {
		   if ($NPI == 1) {
			fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared_int. "            ". $xpi_cond."E-01"."     ". $xpi_calor."E-01". "   ". $xpi_dens."E-01". "\r\n");
		   } else {
		...
		if ( $Si > 1 and $Si <= 9 and $Sj == $j and $Sk < $IJK ) {
		  if ($Si == 3 and $Sj == $j and  $Sk == 2) {
			  if ($NPTAS == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xps_puerta_cond."E-01". "     ". $xps_puerta_calor."E-01". "   ". $xps_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_s."E-01". "     ". $xcp_pared_s."E-01". "   ". $xdens_pared_s."E+03". "\r\n");
			  }
			} else {
			...
			if ($Si == 5 and $Sj == $j and  $Sk == 3) {
			  if ($NVNAS == 1) {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $ventana. "            ".$xps_vent_cond."E-01". "     ".$xps_vent_calor."E-01". "   ".$xps_vent_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_s."E-01". "     ". $xcp_pared_s."E-01". "   ". $xdens_pared_s."E+03". "\r\n");
			  }
			  fwrite($propiedades, $Si. "             ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_s."E-01". "     ". $xcp_pared_s."E-01". "   ". $xdens_pared_s."E+03". "\r\n");
		...
		if ( $Si > 9 and $Si < $i and $Sj > 1 and $Sj < $j and $Sk == 1 ) {
			fwrite($propiedades, $Si. "             ". $Sj. "          " .$Sk. "              ". $piso. "            ". $cond_piso. "     ". $cp_piso. "   ". $dens_piso. "\r\n");
		} else {
		if ( $Si > 9 and $Si <$i and $Sj > 1 and $Sj < $j and $Sk < $IJK ) {
			fwrite($propiedades, $Si. "           ". $Sj. "          " .$Sk. "              ". $aire. "            ". $cond_aire. "     ". $cp_aire. "   ". $dens_aire. "\r\n");
		} else {
		if ( $Si > 9 and $Si < $i and $Sj > 1 and $Sj < $j and $Sk == $IJK ) {
			fwrite($propiedades, $Si. "           ". $Sj. "          " .$Sk. "              ". $techo. "            ". $xcond_pl."E-01". "     ". $xcp_tpl."E-01". "   ". $xdens_tpl."E+03". "\r\n");
		} else {
		if ( $Si > 9 and $Si < $i and $Sj == $j and $Sk == 1 ) {
			fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $piso. "            ". $cond_piso. "     ". $cp_piso. "   ". $dens_piso. "\r\n");
		} else {
		if ( $Si >  9 and $Si < $i and $Sj == $j and $Sk < $IJK ) {
			fwrite($propiedades, $Si. "           ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_n."E-01". "     ". $xcp_pared_n."E-01". "   ". $xdens_pared_n."E+03". "\r\n");
		} else {
		if ( $Si > 9 and $Si < $i and $Sj == $j and $Sk == $IJK ) {
			fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $techo. "            ". $xcond_pl."E-01". "     ". $xcp_tpl."E-01". "   ". $xdens_tpl."E+03". "\r\n");
		} else {
		if ( $Si == $i and $Sj > 1 and $Sj < $j and $Sk == 1 ) {
			fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $piso. "            ". $cond_piso. "     ". $cp_piso. "   ". $dens_piso. "\r\n");
		} else {
		if ( $Si == $i and $Sj > 1 and $Sj < $j and $Sk < $IJK ) {
		  if ($Si == $i and $Sj == 2 and  $Sk == 2) {
			  if ($NPTAO == 1) {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xpo_puerta_cond."E-01". "     ". $xpo_puerta_calor."E-01". "   ". $xpo_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_o."E-01". "     ". $xcp_pared_o."E-01". "   ". $xdens_pared_o."E+03". "\r\n");
			  }
			} else {
			if ($Si == $i and $Sj == 2 and  $Sk == 3) {
			  if ($NPTAO == 1) {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $puerta. "            ". $xpo_puerta_cond."E-01". "     ". $xpo_puerta_calor."E-01". "   ". $xpo_puerta_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_o."E-01". "     ". $xcp_pared_o."E-01". "   ". $xdens_pared_o."E+03". "\r\n");
			...
			if ($Si == $i and $Sj == 5 and  $Sk == 3) {
			  if ($NVNAO == 1) {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $ventana. "            ".$xpo_vent_cond."E-01". "     ".$xpo_vent_calor."E-01". "   ".$xpo_vent_dens."E+03". "\r\n");
			  } else {
				  fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $pared. "            ". $xcond_pared_o."E-01". "     ". $xcp_pared_o."E-01". "   ". $xdens_pared_o."E+03". "\r\n");
			  }
			} else {
		...
		if ( $Si == $i and $Sj > 1 and $Sj < $j and $Sk == $IJK ) {
			fwrite($propiedades, $Si. "            ". $Sj. "             " .$Sk. "              ". $techo. "            ". $cond_piso. "     ". $cp_piso. "   ". $dens_piso. "\r\n");
		} else {
...
for ($Ci = 2; $Ci <= $cara_i; $Ci = $Ci + 1) {
	if ($Ci == 2) {
		...
		if ($xy < 1) {
			...
			fwrite($nodales, number_format($xy/100, 2, ".", "")."E+00". "\r\n");
		}
...
for ($Cj = 2; $Cj <= $cara_j; $Cj = $Cj + 1) {
	if ($Cj == 2) {
		...
		if ($yx < 1) {
			...
			fwrite($nodales, number_format($yx/10, 2, ".", "")."E+00". "\r\n");
		}
